...
public final class Session {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(user, session.user) && Objects.equals(word, session.word) &&
		       Arrays.equals(characters, session.characters) && Objects.equals(fails, session.fails) &&
		       Objects.equals(completedCharacters, session.completedCharacters);
	}
	...
	public String toString() {
		return "Session{" + "user='" + user + '\'' + ", word=" + word + ", characters=" + Arrays.toString(characters) +
		       ", fails=" + fails + ", completedWords=" + completedCharacters + '}';
	}
}
